...
@section('content')
    <div class="flex mb-4" id="content-wrapper">
        ...
        <a class="cart-icon block fixed rounded-full bg-blue pl-3 pt-2 pr-3 pb-2" href="{{ route('signout') }}">Logout</a>
        ...
        <a id="cart-button" class="cart-icon block lg:hidden fixed rounded-full bg-blue pl-3 pt-2 pr-3 pb-2">
